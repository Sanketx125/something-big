...
def _resolve_ribbon_icon_color(
    ...
    contextual_map = {
        ...
        ("byclassribbon", "algorithms", "low"): "icon_low_points",
        ...
        # Draw
        ("drawribbon", "tools", "smart"): "icon_smart_line",
        ...
        ("drawribbon", "tools", "move v"): "icon_move_vertex",
        ...
        # Curve
        ("curveribbon", "curve tools", "curve"): "icon_curve",

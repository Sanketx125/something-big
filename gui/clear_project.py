...
#     ✅ NEW: Asks user if they want to save before clearing (Save/Don't Save/Cancel).
#     """
#     # ============================================================================
...
#                     # Ask user if they want to continue despite save failure
#                     continue_reply = QMessageBox.warning(
#                         app,
#                         "Save Failed",
#                         f"Failed to save the project:\n\n{e}\n\n"
#                         "Do you still want to clear the project?",
#                         QMessageBox.Yes | QMessageBox.No,
#                         QMessageBox.No
#                     )
...
#         # ============================================================================
#         # ✅ KEEP DOCKS OPEN - Just Clear Point Cloud Data Inside
#         # ============================================================================
...
#                         # Remove all actors (point cloud data)
#                         vtk_widget.renderer.RemoveAllViewProps()
#                         # Render the empty view
#                         vtk_widget.render()
#                     print(f"  ✅ Cleared data from cross-section view {view_idx}")
#                 except Exception as e:
#                     print(f"  ⚠️ Failed to clear view {view_idx}: {e}")
            
#             print(f"✅ Cross-section views cleared (docks remain open)")

#         # ============================================================================
#         # ✅ Clear Section Controller Data (but keep structure)
#         # ============================================================================
#         if hasattr(app, 'section_controller') and app.section_controller:
#             try:
#                 # Clear sections data, but keep viewvtks references
#                 if hasattr(app.section_controller, 'sections'):
#                     app.section_controller.sections.clear()
                
#                 print("✅ Section controller data cleared (structure preserved)")
#             except Exception as e:
#                 print(f"⚠️ Section controller clear failed: {e}")

#         # ============================================================================
#         # ✅ Clear Cross-Section Drawing State
#         # ============================================================================
#         if hasattr(app, "cross_interactor"):
#             app.cross_interactor = None
#             print("✅ Cross-section interactor detached")
            
#         if hasattr(app, "cross_action") and app.cross_action:
#             if hasattr(app.cross_action, "setChecked"):
#                 app.cross_action.setChecked(False)
#             print("✅ Cross-section UI action reset")

#         # ============================================================================
#         # ✅ Clear Main Viewer (but preserve DXF attachments)
#         # ============================================================================
...
#                 print(f"✅ Backing up {len(dxf_actors_backup)} DXF actors")
...
#             print(f"✅ Main viewer cleared (DXF preserved: {len(dxf_actors_backup)} actors)")

#         # ============================================================================
#         # Clear Cut Section (including dock)
#         # ============================================================================
#         if hasattr(app, "cut_section_controller") and app.cut_section_controller:
#             try:
#                 app.cut_section_controller.clear()
#                 print("✅ Cut section controller cleared")
#             except Exception as e:
#                 print(f"⚠️ Cut section controller clear failed: {e}")
        
#         # Close the cut section dock with forced close flag
#         if hasattr(app, "cut_section_dock") and app.cut_section_dock:
#             try:
#                 # Create a custom close event with force flag
#                 from PySide6.QtGui import QCloseEvent
#                 close_event = QCloseEvent()
#                 close_event._force_close = True  # ✅ Signal forced close
                
#                 # Send the event
#                 app.cut_section_dock.closeEvent(close_event)
                
#                 # Remove and delete
#                 app.removeDockWidget(app.cut_section_dock)
#                 app.cut_section_dock.deleteLater()
#                 app.cut_section_dock = None
#                 print("✅ Cut section dock closed and deleted")
#             except Exception as e:
#                 print(f"⚠️ Cut section dock close failed: {e}")
        
#         # ✅ Also clear cut_vtk reference in controller
#         if hasattr(app, "cut_section_controller") and app.cut_section_controller:
#             try:
#                 if hasattr(app.cut_section_controller, 'cut_vtk'):
#                     app.cut_section_controller.cut_vtk = None
#                 if hasattr(app.cut_section_controller, 'cut_dock'):
#                     app.cut_section_controller.cut_dock = None
#                 print("✅ Cut section controller references cleared")
#             except Exception as e:
#                 print(f"⚠️ Cut section reference clear failed: {e}")
...
#         # Clear view palettes (will be restored on reload)
#         if hasattr(app, "view_palettes"):
#             app.view_palettes.clear()
#             print("✅ View palettes cleared")
...
#                 app.display_dialog.deleteLater()
#                 app.display_dialog = None
#                 print("✅ Display Mode dialog closed")
#             except Exception as e:
#                 print(f"⚠️ Display Mode close failed: {e}")

#         if hasattr(app, "display_mode_dialog") and app.display_mode_dialog:
#             try:
#                 app.display_mode_dialog.close()
#                 app.display_mode_dialog.deleteLater()
...
#         if hasattr(app, "statusBar"):
#             if should_save:
#                 app.statusBar().showMessage("🧹 Project saved and cleared successfully", 5000)
#             else:
#                 app.statusBar().showMessage("🧹 Project cleared (not saved)", 5000)

#         print("="*60)
#         if should_save:
#             print("✅ PROJECT SAVED AND CLEARED (CROSS-SECTION DOCKS KEPT OPEN)")
#         else:
#             print("✅ PROJECT CLEARED WITHOUT SAVING (CROSS-SECTION DOCKS KEPT OPEN)")
#         print("="*60 + "\n")

...
class ClassVisibilityPicker(QDialog):
    ...
    def __init__(self, app_window, mode="display", parent=None):
        ...
        if mode != "display":
            ...
            if mode == "shading":
                table_note = QLabel("Select which classes to include in this shading preset:")
    ...
    def _populate_classes(self):
        ...
        if hasattr(self, 'class_table') and self.class_table is not None:
            ...
            for code, entry in sorted(self.app_window.class_palette.items()):
                ...
                # ✅ Column 3 for shading, column 4 for display
    ...
    def _on_ok_clicked(self):
        ...
        if self.mode == "display" and hasattr(self, 'border_spin'):
            ...
            self.app_window.display_border_logic_mode = border_type
            print(f"✅ Stored border: {border_val}% (type: {border_type})")
    ...
    def _on_view_selector_changed(self, new_index):
        ...
        view_name = (["Main View", "View 1", "View 2", "View 3", "View 4", "Cut Section View"]
                     [new_index] if new_index < 6 else f"View {new_index}")
...
class ShortcutManager(QWidget):
    ...
    def __init__(self, app_window, parent=None):
        ...
        # Add bottom margin so rows don't hide behind buttons when scrolling
        self.table.verticalScrollBar().setStyleSheet(
            "QScrollBar:vertical { margin-bottom: 80px; }"
        )

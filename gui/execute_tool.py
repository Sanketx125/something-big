...
#     # When classification is activated, measurement undo/redo must be disabled
#     # ═══════════════════════════════════════════════════════════════════════════
#     if hasattr(app_window, 'measurement_tool') and app_window.measurement_tool:
#         mt = app_window.measurement_tool
#         if getattr(mt, 'active', False) or (hasattr(mt, 'measurements') and len(mt.measurements) > 0):
